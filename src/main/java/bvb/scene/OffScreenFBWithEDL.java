...
public class OffScreenFBWithEDL
{
	private int vaoQuad;
	 ...
	 */
	public OffScreenFBWithEDL( final int fbWidth, final int fbHeight, final int internalFormat )
	{
	 ...
	 */
	public OffScreenFBWithEDL( final int fbWidth, final int fbHeight, final boolean flipY )
	{
	 ...
	 * @param flipY whether to flip the Y axis when
	 */
	public OffScreenFBWithEDL( final int fbWidth, final int fbHeight, final int internalFormat, final boolean flipY )
	{
	...
	public void drawQuadEDL( GL3 gl, float fRadius, float fStrength)
	{
		initQuad( gl );
